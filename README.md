...
- It is notable that even though the texts are quite different but share the same title and some relation to school information, the cosine similarity measured by the BERT model is quite high. This may be because BERT is very effective at understanding context. Perhaps in another iteration, fine-tuning BERT would show an improvement in achieving more accurate text similarity.
